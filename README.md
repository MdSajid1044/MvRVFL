...
In this demonstration, the codes are run for fixed hyperparameter for the “breast_cancer_wisc_prog” dataset
c1 = 0.00001
c2 = 1000
rho =0.01
N = 23

For detailed hyperparameter setting, please refer to the paper.
